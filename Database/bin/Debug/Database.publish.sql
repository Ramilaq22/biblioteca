...
CREATE TABLE [dbo].[Editorial] (
    ...
    [Name]        VARCHAR (255) NOT NULL,
    CONSTRAINT [PK_Editorial] PRIMARY KEY CLUSTERED ([EditorialID] ASC)
);


GO
PRINT N'Creando [dbo].[Loan]...';
...
GO
PRINT N'Creando [dbo].[FK_BookAuthor]...';


GO
ALTER TABLE [dbo].[Book]
    ADD CONSTRAINT [FK_BookAuthor] FOREIGN KEY ([AuthorID]) REFERENCES [dbo].[Author] ([AuthorID]);


GO
PRINT N'Creando [dbo].[FK_BookEditorial]...';


GO
ALTER TABLE [dbo].[Book]
    ADD CONSTRAINT [FK_BookEditorial] FOREIGN KEY ([EditorialID]) REFERENCES [dbo].[Editorial] ([EditorialID]);


GO
PRINT N'Creando [dbo].[FK_LoanBook]...';


GO
ALTER TABLE [dbo].[Loan]
    ADD CONSTRAINT [FK_LoanBook] FOREIGN KEY ([BookID]) REFERENCES [dbo].[Book] ([BookID]);


GO
PRINT N'Creando [dbo].[FK_LoanPartner]...';


GO
ALTER TABLE [dbo].[Loan]
    ADD CONSTRAINT [FK_LoanPartner] FOREIGN KEY ([PartnerID]) REFERENCES [dbo].[Partner] ([PartnerID]);
